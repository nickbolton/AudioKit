...
class PlaygroundView: AKPlaygroundView {
    ...
    func printCode() {
        ...
        print("    decimation = \(String(format: "%0.3f", decimator.decimation))")
        print("    rounding = \(String(format: "%0.3f", decimator.rounding))")
        print("    mix = \(String(format: "%0.3f", decimator.mix))")
        print("}\n")
    }
