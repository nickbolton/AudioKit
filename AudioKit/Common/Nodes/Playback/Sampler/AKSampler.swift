...
public class AKSampler: AKNode {
    ...
    ///
    public func loadAKAudioFile(_ file:AKAudioFile) throws
    {
        do {
    ...
    ///
    public func loadPath(_ filePath: String) {
        do {
    ...
    ///
    public func play(noteNumber: MIDINoteNumber = 60, velocity: MIDIVelocity = 127, channel: Int = 0) {
    ...
    ///   - channel: MIDI Channnel
    ///
    public func stop(noteNumber: MIDINoteNumber = 60, channel: Int = 0) {
